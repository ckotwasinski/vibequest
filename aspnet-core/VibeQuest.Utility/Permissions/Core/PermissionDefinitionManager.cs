...
namespace VibeQuest.Utility.Permissions
{
    public class PermissionDefinitionManager : IPermissionDefinitionManager
    {
        ...
        public virtual PermissionDefinition Get(string name)
        {
            ...
            if (permission == null)
            {
                throw new UserFriendlyException("Undefined permission: " + name);
            }
            ...
            PermissionDefinition permission)
        {
            ...
            {
                throw new UserFriendlyException("Duplicate permission name: " + permission.Name);
            }
